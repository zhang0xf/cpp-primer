...
inline void StrVec::emplace_back(Args &&...args) {
    check_n_alloc();                                            // 如果需要的话重新分配StrVec内存空间
    alloc.construct(first_free++, std::forward<Args>(args)...); // 既扩展了模版参数包Args,又扩展了函数参数包args
}
